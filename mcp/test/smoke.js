...
async function main() {
  ...
  expect(names.length === 5, `tools/list returns 5 tools (got ${names.length})`);
  for (const wanted of ['create_room', 'send_message', 'wait_for_messages', 'get_transcript', 'room_status']) {
